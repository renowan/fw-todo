<template>
  <div tabs>
    <ul :class="navStyleClass" role="tablist" v-if="!invalid">
      <template v-for="header in headers">
        <li v-if="header._isTab" class="tab" :class="{active:header.active, disabled:header.disabled}" @click.prevent="select(header)">
